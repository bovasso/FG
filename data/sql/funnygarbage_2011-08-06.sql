...
# Generation Time: 2011-08-06 22:59:49 +0000
# ************************************************************
...
CREATE TABLE `client` (
  ...
  CONSTRAINT `client_logo_dm_media_id` FOREIGN KEY (`logo`) REFERENCES `dm_media` (`id`)
...
VALUES
	(81,1,'admin','dmAdmin','index',0,1312671085,'admin','/admin.php','en'),
	(93,1,'admin','dmPage','index',0,1312671087,'admin','/admin.php/seo/pages/manage-pages/index','en'),
	(94,1,'admin','dmPage','reorderPages',0,1312671089,'admin','/admin.php/seo/pages/manage-pages/reorderPages','en'),
	(95,1,'admin','dmPage','manageMetas',0,1312671094,'admin','/admin.php/seo/pages/manage-pages/manageMetas','en'),
	(96,1,'admin','dmSearchEngine','index',0,1312671128,'admin','/admin.php/tools/search-engine/manage-index/index?search%5Bquery%5D=Drupal','en'),
	(97,1,'admin','dmSearchEngine','reload',0,1312671099,'admin','/admin.php/tools/search-engine/manage-index/reload','en');
...
VALUES
	(1,3,'118470584372x41cn.jpg',NULL,NULL,NULL,'image/jpeg',1773,NULL,'2011-08-06 14:58:26','2011-08-06 14:58:26'),
	(2,3,'118477369472x41wb.jpg',NULL,NULL,NULL,'image/jpeg',1418,NULL,'2011-08-06 14:58:26','2011-08-06 14:58:26'),
	(3,3,'125875148172x41afta.jpg',NULL,NULL,NULL,'image/jpeg',3556,NULL,'2011-08-06 14:58:26','2011-08-06 14:58:26'),
	(4,3,'125900670372x41_lifetime.jpg',NULL,NULL,NULL,'image/jpeg',1615,NULL,'2011-08-06 14:58:26','2011-08-06 14:58:26'),
	(5,3,'125900672872x41_teennick.jpg',NULL,NULL,NULL,'image/jpeg',1758,NULL,'2011-08-06 14:58:26','2011-08-06 14:58:26'),
	(6,3,'125900677972x41_wenner.jpg',NULL,NULL,NULL,'image/jpeg',2649,NULL,'2011-08-06 14:58:26','2011-08-06 14:58:26'),
	(7,3,'screen-shot-2011-04-07-at-1-06-09-pm.png',NULL,NULL,NULL,'image/png',6448,NULL,'2011-08-06 14:58:26','2011-08-06 14:58:26'),
	...
	(106,6,'640x480_abc-mole-5_1.jpg',NULL,NULL,NULL,'image/jpeg',91360,'640x480','2011-08-06 14:58:26','2011-08-06 16:38:16'),
	...
	(163,6,'screen-shot-2011-05-18-at-4-58-14-pm.png',NULL,NULL,NULL,'image/png',419742,'634x614','2011-08-06 14:58:27','2011-08-06 16:38:17'),
	...
	(172,6,'thumb_comedycentral.jpg',NULL,NULL,NULL,'image/jpeg',60691,'298x130','2011-08-06 14:58:27','2011-08-06 16:38:17'),
	...
	(210,8,'screen-shot-2011-05-24-at-2-58-15-pm.png',NULL,NULL,NULL,'image/png',113685,NULL,'2011-08-06 14:58:27','2011-08-06 14:58:27'),
...
VALUES
	(1,'main','root',0,'',1,78,0),
	(2,'main','error404',0,NULL,4,5,1),
	(3,'main','signin',0,NULL,2,3,1),
	(4,'jobPosition','list',0,'',6,21,1),
	(5,'dmTag','list',0,NULL,22,23,1),
	(6,'category','list',0,NULL,24,47,1),
	(7,'client','list',0,NULL,48,49,1),
	(8,'staffMember','list',0,NULL,50,55,1),
	(9,'serviceCategory','list',0,NULL,56,67,1),
	(10,'category','show',1,'',25,26,2),
	(11,'category','show',2,NULL,27,28,2),
	(12,'category','show',3,NULL,29,30,2),
	(13,'category','show',4,NULL,31,32,2),
	(14,'category','show',5,'',33,34,2),
	(15,'category','show',6,NULL,35,36,2),
	(16,'category','show',7,NULL,37,38,2),
	(17,'category','show',8,NULL,39,40,2),
	(18,'category','show',9,NULL,41,42,2),
	(19,'category','show',10,NULL,43,44,2),
	(20,'category','show',11,NULL,45,46,2),
	(22,'staffMember','show',1,NULL,51,52,2),
	(23,'staffMember','show',2,NULL,53,54,2),
	(24,'main','about',0,'',68,69,1),
	(25,'main','contact',0,'',70,71,1),
	(26,'main','portfolio',0,'',72,73,1),
	(27,'serviceCategory','show',1,NULL,57,58,2),
	(28,'serviceCategory','show',2,NULL,59,60,2),
	(29,'serviceCategory','show',3,NULL,61,62,2),
	(30,'serviceCategory','show',4,NULL,63,64,2),
	(31,'serviceCategory','show',5,NULL,65,66,2),
	...
	(39,'main','searchResults',0,NULL,74,75,1),
	(40,'main','search',0,NULL,76,77,1);
...
VALUES
	...
	(10,'Diem base urls for different applications/environments/cultures','{\"admin-prod\":\"http:\\/\\/dev.funnygarbage.com\\/admin.php\",\"front-prod\":\"http:\\/\\/dev.funnygarbage.com\\/index.php\"}','','en'),
...
VALUES
	(1,'admin','admin@www.com','sha1','4c10ceb29460022d66b6f1cd6df82d57','4e8aa5e81cc371b3f9a37a71efe6b771e1c6e7b9',1,1,NULL,NULL,'2011-08-06 14:52:03','2011-08-06 14:52:03',NULL,NULL);
...
VALUES
	...
	(10,32,'main','footer','',-8,'2011-08-06 15:26:39'),
	...
	(44,77,'main','aboutOverview','overview_content',1,'2011-08-06 16:52:16'),
	(45,86,'dmWidgetContent','title','shdr',1,'2011-08-06 16:55:10'),
	(46,86,'staffMember','list','',2,'2011-08-06 16:55:10'),
	...
	(67,30,'project','listFeatured','',2,'2011-08-06 17:40:24'),
	(68,80,'category','list','sidebar',1,'2011-08-06 17:41:12'),
	(69,80,'project','list','',2,'2011-08-06 17:41:12'),
	(71,89,'jobApplication','form','',1,'2011-08-06 17:54:08'),
	(72,54,'jobPosition','show','',1,'2011-08-06 18:09:30'),
	(75,41,'dmWidgetContent','title','',1,'2011-08-06 18:32:11'),
	(76,38,'category','list','sidebar',1,'2011-08-06 18:33:09'),
	(77,41,'project','listFeaturedByCategory','',2,'2011-08-06 18:32:11'),
	(78,38,'project','listByCategory','',2,'2011-08-06 18:33:09'),
...
VALUES
	...
	(69,'{\"orderField\":\"title\",\"orderType\":\"asc\",\"maxPerPage\":12,\"navTop\":true,\"navBottom\":true}','en'),
	(71,'[]','en'),
	(72,'{\"recordId\":null}','en'),
...
CREATE TABLE `project` (
  ...
  `launch_date` varchar(60) COLLATE utf8_unicode_ci NOT NULL,
